            ...
            <div className="mx-auto max-w-7xl px-2 py-2 sm:px-6 lg:px-8">
              <div className="relative flex h-16 items-center justify-between">
                      ...
                      {navigation.map((item) => (
                        <Link
                          ...
                          className={classNames(
                            item.current ? 'text-[#FE5D37]' : 'text-[#103741] hover:text-[#FE5D37]',
                            'rounded-md px-1 md:px-2 lg:px-3 py-2 lg:text-xl md:text-base sm:text-sm font-medium font-Heebo '
                          )}
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                  <button
                    type="button"
                    className="relative rounded-full bg-[#FE5D37] text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800
                    py-2 px-4 flex gap-2 font-Heebo lg:text-xl md:text-base sm:text-sm items-center"
                  >
                    <span>Join Us</span>                                                                                        
